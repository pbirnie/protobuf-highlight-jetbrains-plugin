...
import com.jumpnotzerosoftware.jetbrains.plugin.ProtoHighPluginController;
...
public class SentryBugReporter extends ErrorReportSubmitter {
    ...
    // from https://sentry.io/settings/jump-not-zero-software/projects/protobuf-highlight/keys/
    private static final String DSN = "https://8ce7752e065a445dae56545b89f94eda:f0615b21e59143019729fb6a1c0a0d9d@sentry.io/1485174";

    public static final SentryClient sentry = Sentry.init(DSN);
    ...
    private static String getPluginVersion() {
        IdeaPluginDescriptor plugin = PluginManager.getPlugin(PluginId.getId(ProtoHighPluginController.PLUGIN_ID));
        if (plugin == null) {
            return "unknown";
        }
